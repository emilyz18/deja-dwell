...
import { getAllTenantProfileAsync, getAllTenantPrefAsync } from '../../redux/tenant/thunks';
import { getMatchesAsync, updateMatchAsync } from '../../redux/matches/matchThunks';
...
const LandlordPropertyCard = ({ landlordId }) => {
  ...
  useEffect(() => {
    if (matches.length > 0 && tenants.length > 0 && tenantPrefs.length > 0 && users.length > 0) {
        ...
        <div className="landlord-dashboard-display">
          <div className="landlord-property-card">
            <div className="landlord-carousel-container">
              <Carousel data={images} size={{ width: '400px', height: '240px' }} />
            </div>
