  ...
  return (
    <div className="property-display-container">
      ...
      <div className="info-grid">
        ...
        <PropertyAttribute
          label="Start Date"
          value={property.StartDate ? formatDate(property.StartDate) : 'N/A'}
        />
        <PropertyAttribute
          label="End Date"
          value={property.EndDate ? formatDate(property.EndDate) : 'N/A'}
        />
        <PropertyAttribute
        ...
        <PropertyAttribute
          label="Own Pet"
          value={property.AllowPet ? 'Yes' : 'No'}
        />
        <PropertyAttribute
          label="Smoke"
          value={property.AllowSmoke ? 'Yes' : 'No'}
        />
        <PropertyAttribute
          label="Party"
          value={property.AllowParty ? 'Yes' : 'No'}
        />
        <PropertyAttribute
          label="Weed"
          value={property.AllowWeed ? 'Yes' : 'No'}
        />
        <PropertyAttribute
          label="AC included"
          value={property.isAC ? 'Yes' : 'No'}
        />
        <PropertyAttribute
          label="Heater included"
          value={property.isHeater ? 'Yes' : 'No'}
        />
        <PropertyAttribute
          label="Furnished"
