              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12}>
                  <TextField
                      ...
                      margin="normal"
                  />
                  <Button value={user.ProfileImg || ''} component="label" variant="contained" className="upload-button">
                    Upload Photo
                ...
                <Grid item xs={12} className="button-container">
                  ...
                  <Button className="button" variant="contained" color="primary" onClick={handleCancel}>
                    Cancel
                  </Button>
                </Grid>
              </Grid>
