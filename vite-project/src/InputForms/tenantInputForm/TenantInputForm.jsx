        ...
        {isEditing ? (
            ...
            <Box className="tenant-input-form">
              ...
              <div className="info-grid">
                ...
                <Typography className="value">{tenant.Occupation || 'N/A'}</Typography>
              ...
              <div className="info-grid">
                ...
                <Typography className="value">{tenantPref.Province || 'N/A'}</Typography>
                <Typography className="label">City</Typography>
                <Typography className="value">{tenantPref.City || 'N/A'}</Typography>
                <Typography className="label">Street</Typography>
                <Typography className="value">{tenantPref.Street || 'N/A'}</Typography>
                <Typography className="label">Expected Price</Typography>
                <Typography className="value">{tenantPref.ExpectedPrice || 'N/A'}</Typography>
                <Typography className="label">Max Price</Typography>
                <Typography className="value">{tenantPref.MaxPrice || 'N/A'}</Typography>
                <Typography className="label">Start Date</Typography>
                <Typography className="value">{tenantPref.StartDate || 'N/A'}</Typography>
                <Typography className="label">End Date</Typography>
                <Typography className="value">{tenantPref.EndDate || 'N/A'}</Typography>
                <Typography className="label">Duration</Typography>
                <Typography className="value">{tenantPref.Duration || 'N/A'}</Typography>
                <Typography className="label">Room Type</Typography>
                <Typography className="value">{tenantPref.RoomType || 'N/A'}</Typography>
                <Typography className="label">Own Pet</Typography>
                <Typography className="value">{tenantPref.isOwnPet ? 'Yes' : 'No'}</Typography>
                <Typography className="label">Smoke</Typography>
                <Typography className="value">{tenantPref.isSmoke ? 'Yes' : 'No'}</Typography>
                <Typography className="label">Party</Typography>
                <Typography className="value">{tenantPref.isParty ? 'Yes' : 'No'}</Typography>
                <Typography className="label">Weed</Typography>
                <Typography className="value">{tenantPref.isWeed ? 'Yes' : 'No'}</Typography>
                <Typography className="label">Number of Parking</Typography>
                <Typography className="value">{tenantPref.NumOfParking || 'N/A'}</Typography>
                <Typography className="label">Number of Resident</Typography>
                <Typography className="value">{tenantPref.NumOfResident || 'N/A'}</Typography>
              </div>
              <Button
                  variant="contained"
                  color="primary"
