    ...
    <>
      {isEditing ? (
        ...
        <Box className="general-input-form">
          ...
          <Typography className="list-item">
            Income: {tenant.Income || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Company: {tenant.Company || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Habit: {tenant.Habit || 'N/A'}
          </Typography>
          ...
          <Typography className="list-item">
            Province: {tenantPref.Province || 'N/A'}
          </Typography>
          <Typography className="list-item">
            City: {tenantPref.City || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Street: {tenantPref.Street || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Expected Price: {tenantPref.ExpectedPrice || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Max Price: {tenantPref.MaxPrice || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Start Date: {tenantPref.StartDate || 'N/A'}
          </Typography>
          <Typography className="list-item">
            End Date: {tenantPref.EndDate || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Duration: {tenantPref.Duration || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Room Type: {tenantPref.RoomType || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Own Pet: {tenantPref.isOwnPet ? 'Yes' : 'No'}
          </Typography>
          <Typography className="list-item">
            Smoke: {tenantPref.isSmoke ? 'Yes' : 'No'}
          </Typography>
          <Typography className="list-item">
            Party: {tenantPref.isParty ? 'Yes' : 'No'}
          </Typography>
          <Typography className="list-item">
            Weed: {tenantPref.isWeed ? 'Yes' : 'No'}
          </Typography>
          <Typography className="list-item">
            Number of Parking: {tenantPref.NumOfParking || 'N/A'}
          </Typography>
          <Typography className="list-item">
            Number of Resident: {tenantPref.NumOfResident || 'N/A'}
          </Typography>
          <Button
            variant="contained"
            color="primary"
