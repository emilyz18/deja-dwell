...
- **Unit 2 - React/Redux** - The user interface was developed with React, combining CSS and Material-UI components to achieve a clean and cohesive design. Redux was integral in managing the application's state, facilitating smooth data flow and synchronization across various UI components.
